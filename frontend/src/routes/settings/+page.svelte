<script lang="ts">
	...
	const providers = [
		...
		{
			value: 'huggingface/mistralai/Ministral-3-14B-Reasoning-2512',
			label: 'HuggingFace Ministral'
		},
...
<div class="space-y-8 max-w-2xl">
	<div>
		...
		<p class="mt-1 text-sm text-gray-400">
			Configure LLM provider, voice engine, and robot connection.
		</p>
	</div>
	...
	<section class="space-y-4">
		...
		<div class="space-y-3">
			<label class="block">
				...
				<select
					bind:value={$settings.voiceEngine}
					class="mt-1 block w-full rounded-lg bg-gray-800 border border-gray-700 px-3 py-2 text-sm text-gray-200"
				>
	...
	<section class="space-y-4">
		...
		<label class="flex items-center gap-2">
			<input
				type="checkbox"
				bind:checked={$settings.simulation}
